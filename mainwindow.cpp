...
void MainWindow::on_pushButton_12_clicked()// ajouter conge
{
...
void MainWindow::on_pushButton_6_clicked() // supp conge
{
...
void MainWindow::on_pushButton_13_clicked()//modifier conge
{
...
void MainWindow::on_pushButton_14_clicked()// recherchefil modifier
{
    QString id = ui->lineEdit_35->text();
           QSqlQuery query;
...
void MainWindow::on_pushButton_8_clicked()// ajou empl
{
...
void MainWindow::on_tabWidget_3_currentChanged(int index)// affich employe
{
    if ( index == 0){
...
void MainWindow::on_pushButton_9_clicked()// supp fil employe
{
...
void MainWindow::on_pushButton_15_clicked()// recherch fil mod employe
{
